...
### [前端]更新项目文件中关于BBS-GO的遗留链接与说明为关于我们的内容，本地测试无误后群内更新项目文件【单】(10分)

### [前端]更新项目文件内的Logo为群内投票决定的新Logo雏形，本地测试无误后上传修改版本于群内【单】(10分)For 谢红伟

### [后台]根据邮件服务器的信息配置项目本地运行，测试用户注册功能，无误后将配置文件上传至群【单】(10分)

### 根据群内票决的结果，继续精进Logo的设计服务【单】(5分)For 李佳佳
