...
### [前端]更新项目文件中关于框架基础的遗留链接与说明为关于我们的内容，本地测试无误后群内更新项目文件【单】(10分)`Done` 谢红伟

### [前端]更新项目文件内的Logo为群内投票决定的新Logo雏形，本地测试无误后上传修改版本于群内【单】(10分)`Done:`谢红伟

### [后台]根据邮件服务器的信息配置项目本地运行，测试用户注册功能，无误后将配置文件上传至群【单】(10分)`Done:` 郭新强
...
### [前端]修改原型论坛的按钮等与logo色调匹配【单】(7分)`Done:` 谢红伟
...
`Done:`何振威*2
### [前端]编程实现将群内投票选出的BGM作为维之初的背景音乐循环播放【单】(10分)`Done` 谢红伟

### [运维]申请qq登录介入接口，并配置到服务器【单】 (10分) `Done:` 何振威
...
### [美工]指点前端‘新剧本’的布局设计，并提供相关UI。【单】(10分)`Done:`李佳佳

### [数据/后台]设计一种新的数据表，模仿原生代码写一个控制器用于描述'新剧本'中多分支剧情线的的内容(控制器构造可参考编程刑侦学)【双】(20分)`Done:` 谢红伟 郭新强

### [美工]设计互动剧本列表项艺术感的花边边框UI 【单】(10分)`Done:`李佳佳

### [前端/后台]结合互动剧本列表项UI与后台数据设计显示互动剧本列表【双】(20分) `Done:` 郭新强 谢红伟

## DebugList

### [Debug]修复发表推文限制字数、图片描述不准确的bug【单】(6分)`Done:` 何振威

### [Debug]修复部分终端广告位显示空白的伪BUG【单】(7分) `Done:` 郭新强

### [Debug]修复所有文本编辑框全屏后不能退出的BUG【单】(7分) `Done:` 谢红伟

### [Debug]修复了电脑端视频播放不能全屏的问题【单】(7分) `Done:` 谢红伟

### [Debug]修复无二级域名无法访问主站以及收藏提醒无法访问的bug【单】(7分)`Done:`高璞

## 文档总结：

### 根据项目情况如实填写文档可行性研究报告【单】(10分)`Done:`王梦明

### 根据项目情况如实填写文档软件需求说明书【单】(10分)  `Done:` 郭新强

### 根据项目情况如实填写文档概要设计说明书【单】(10分)`Done:` 高璞

### 根据项目情况如实填写文档详细设计说明书【单】(10分)`Done:` 谢红伟

### 根据项目情况如实填写文档测试计划【单】(10分) `Done:` 何振威

### 根据项目情况如实填写文档用户手册【单】(10分)`Done:`李学豪

### 根据项目情况如实填写项目研讨活动及会议记录【单】(10分) `Done:` 陈乾梦

### 根据项目情况如实填写项目研讨计划表【单】(7分)`Done:`李佳佳
